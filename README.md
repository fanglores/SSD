...
### Проект2: [ssd-project-s09-s12](https://github.com/Dandamaev/ssd-project-s09-s12)
...
- **DV:**
  ...
  - [x] CI build+test зелёный;
  - [x] артефакты в `EVIDENCE/`;
  - [x] секреты - через masked.
- **DS:**
  - [x] SBOM/SCA отчёты;
  - [x] SAST+Secrets;
  - [x] DAST **или** Policy;
  - [x] ≥2 меры харднинга с доказательствами;
  - [x] пороги/триаж;
  - [x] хотя бы один «до/после».
